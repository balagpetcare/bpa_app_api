...
|---|---|---|---|---|---|
| backend-api | https://github.com/balagpetcare/bpa_app_api.git | `main` | `57d908d` | **SUCCESS** | Fast-forward merged `release/V-A1.0.7` (33 commits) |
...
|---|---|---|---|
| backend-api | `57d908d` | `57d908d` | Yes |
